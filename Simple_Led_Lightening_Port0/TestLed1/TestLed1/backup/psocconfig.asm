...
export LoadConfig_testled1
export _LoadConfig_testled1
...
;---------------------------------------------------------------------------
; Load Configuration testled1
;
;    Load configuration registers for testled1.
...
;               CUR_PP
;
_LoadConfig_testled1:
 LoadConfig_testled1:
    RAM_PROLOGUE RAM_USE_CLASS_4
    lcall   LoadConfigTBL_testled1            ; Call load config table routine
