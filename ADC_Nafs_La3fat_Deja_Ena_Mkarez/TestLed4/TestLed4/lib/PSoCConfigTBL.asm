...
export LoadConfigTBL_testled4_Bank1
export LoadConfigTBL_testled4_Bank0
export LoadConfigTBL_testled4_Ordered
AREA lit(rom, rel)
LoadConfigTBL_testled4_Bank0:
;  Instance name DELSIG11_1, User Module DELSIG11
;       Instance name DELSIG11_1, Block Name ADC(ASC10)
	db		80h, 90h		;DELSIG11_1_AtoDcr0(ASC10CR0)
	db		81h, e0h		;DELSIG11_1_AtoDcr1(ASC10CR1)
	db		82h, 60h		;DELSIG11_1_AtoDcr2(ASC10CR2)
	db		83h, f0h		;DELSIG11_1_AtoDcr3(ASC10CR3)
;       Instance name DELSIG11_1, Block Name TMR(DBB00)
	db		23h, 00h		;DELSIG11_1_TimerCR0(DBB00CR0)
	db		21h, 00h		;DELSIG11_1_TimerDR1(DBB00DR1)
	db		22h, 00h		;DELSIG11_1_TimerDR2(DBB00DR2)
;  Instance name LCD_1, User Module LCD
;  Instance name LED_BL, User Module LED
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_testled4_Bank1:
;  Instance name DELSIG11_1, User Module DELSIG11
;       Instance name DELSIG11_1, Block Name ADC(ASC10)
;       Instance name DELSIG11_1, Block Name TMR(DBB00)
	db		20h, 20h		;DELSIG11_1_TimerFN(DBB00FN)
	db		21h, 16h		;DELSIG11_1_TimerSL(DBB00IN)
	db		22h, 40h		;DELSIG11_1_TimerOS(DBB00OU)
;  Instance name LCD_1, User Module LCD
;  Instance name LED_BL, User Module LED
...
LoadConfigTBL_testled4_Ordered:
