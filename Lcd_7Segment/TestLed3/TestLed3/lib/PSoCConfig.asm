...
export LoadConfig_testled3
export _LoadConfig_testled3
...
;---------------------------------------------------------------------------
; Load Configuration testled3
;
;    Load configuration registers for testled3.
...
;               CUR_PP
;
_LoadConfig_testled3:
 LoadConfig_testled3:
    RAM_PROLOGUE RAM_USE_CLASS_4
    lcall   LoadConfigTBL_testled3            ; Call load config table routine
