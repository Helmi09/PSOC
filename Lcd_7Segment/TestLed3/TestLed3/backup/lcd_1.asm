...
LCD_1_Port:           equ    PRT1DR
LCD_1_PortMode0:      equ    PRT1DM0
LCD_1_PortMode1:      equ    PRT1DM1
...
;
 LCD_1_WCNTL_Nibble:
    ...
    and   [Port_1_Data_SHADE],~LCD_1_PORT_MASK
...
LCD_1_WDATA_Nibble:
    ...
    RAM_SETPAGE_CUR >Port_1_Data_SHADE          ; Set CUR_PP to LCD variable address
    and   [Port_1_Data_SHADE],~LCD_1_PORT_MASK
    or    [Port_1_Data_SHADE],LCD_1_RS                ; Raise RS to signify a Data Write
    mov   A,[Port_1_Data_SHADE]
    mov   reg[LCD_1_Port],A
...
LCD_1_Check_Ready:
    ...
    RAM_SETPAGE_CUR >Port_1_Data_SHADE                ; Set CUR_PP to LCD variable address
    and   [Port_1_Data_SHADE],~LCD_1_PORT_MASK        ; Mask of all LCD bits
    mov   A,[Port_1_Data_SHADE]
    mov   reg[LCD_1_Port],A                           ; Zero LCD port bits

    and   [Port_1_DriveMode_0_SHADE],~LCD_1_DATA_MASK ; Clear out LCD mode bits.
    ...
    or    [Port_1_Data_SHADE],LCD_1_RW                ; Raise RW to signify Read operation
    mov   A,[Port_1_Data_SHADE]
    mov   reg[LCD_1_Port],A
    NOP
...
.LCD_RDY_LOOP:
    or    [Port_1_Data_SHADE], LCD_1_CNTL_READ                  ; Raise E to start cycle
    mov   A,[Port_1_Data_SHADE]
    mov   reg[LCD_1_Port],A
...
ENDIF   
    ...
    push  A
    and   [Port_1_Data_SHADE],(~LCD_1_PORT_MASK | LCD_1_RW)     ; Lower E signal
    mov   A,[Port_1_Data_SHADE]
    mov   reg[LCD_1_Port],A
...
.UNLOCK:
    ...
    or    [Port_1_DriveMode_0_SHADE],LCD_1_PORT_WRITE ; Revert Data bit to Write mode
    mov   A,[Port_1_DriveMode_0_SHADE]
    M8C_SetBank1
...
_LCD_1_Init:
    ...
    and   [Port_1_DriveMode_0_SHADE],~LCD_1_PORT_MASK           ; Mask off LCD bits
    or    [Port_1_DriveMode_0_SHADE],LCD_1_PORT_WRITE           ; Set LCD port for writing
    and   [Port_1_DriveMode_1_SHADE],~LCD_1_PORT_MASK           ; Mask off LCD bits
