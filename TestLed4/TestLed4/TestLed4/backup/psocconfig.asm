...
export LoadConfig_testled4
export _LoadConfig_testled4
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_1_DriveMode_0_SHADE], 7fh
	mov		[Port_1_DriveMode_1_SHADE], 80h
	mov		[Port_2_Data_SHADE], 0h

	lcall	LoadConfig_testled4
	lcall	LoadConfigTBL_testled4_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration testled4
;
;    Load configuration registers for testled4.
...
_LoadConfig_testled4:
 LoadConfig_testled4:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_testled4_Bank0
    mov     X, <LoadConfigTBL_testled4_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_testled4_Bank1
    mov     X, <LoadConfigTBL_testled4_Bank1
