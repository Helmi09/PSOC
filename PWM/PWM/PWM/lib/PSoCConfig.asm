...
export LoadConfig_pwm
export _LoadConfig_pwm
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_pwm
	lcall	LoadConfigTBL_pwm_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration pwm
;
;    Load configuration registers for pwm.
...
_LoadConfig_pwm:
 LoadConfig_pwm:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_pwm_Bank0
    mov     X, <LoadConfigTBL_pwm_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_pwm_Bank1
    mov     X, <LoadConfigTBL_pwm_Bank1
