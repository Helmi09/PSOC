...
export LoadConfigTBL_testled2_Bank1
export LoadConfigTBL_testled2_Bank0
export LoadConfigTBL_testled2_Ordered
AREA lit(rom, rel)
LoadConfigTBL_testled2_Bank0:
...
LoadConfigTBL_testled2_Ordered:
