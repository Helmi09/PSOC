...
export LoadConfig_testled2
export _LoadConfig_testled2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_testled2
	lcall	LoadConfigTBL_testled2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration testled2
;
;    Load configuration registers for testled2.
...
_LoadConfig_testled2:
 LoadConfig_testled2:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_testled2_Bank0
    mov     X, <LoadConfigTBL_testled2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_testled2_Bank1
    mov     X, <LoadConfigTBL_testled2_Bank1
